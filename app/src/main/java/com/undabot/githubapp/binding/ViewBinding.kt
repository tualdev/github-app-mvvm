...
object ViewBinding {
  ...
  fun bindToast(view: View, text: String?) {
    text.whatIfNotNullOrEmpty {
      if (it == "Required value 'search' (JSON name 'Search') missing at \$"){
        val alert = AlertDialog.Builder(view.context, R.style.AlertDialogTheme)
        alert.setMessage(R.string.there_is_no_movie_data)
